(function($) {
    ...
    jQuery(document).ready(function() {
        ...
        /* Main Slider */
        var sync1 = $('#em_owlcarousel_4_4428_sync1');
        sync1.owlCarousel({
            singleItem: true,
        ...
        /*New Arrival */
        var owl = $("#em_minifilter_products_273017e230f8173f6504545bce0ccce3").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_273017e230f8173f6504545bce0ccce3').find('img.em-img-lazy');
                    if ($_img.length) {
        ...
        /* Best Sales */
        var owl = $("#em_minifilter_products_b6b6bdc659142f35db29d306b4790211").find('.owl-carousel');
        if (owl.length) {
            owl.owlCarousel({
                //Basic Speeds
                slideSpeed: 800,
                ...
                scrollPerPage: false,
                afterMove: function() {
                    var $_img = jQuery('#em_minifilter_products_b6b6bdc659142f35db29d306b4790211').find('img.em-img-lazy');
                    if ($_img.length) {
                        var timeout = setTimeout(function() {
                            $_img.trigger("appear");
                        }, 200);
